...
const Base64toASCII = () => {
    ...
    const handleSubmit = () => {
        ...
        if (!base64String) {
            AlertBox('ERROR', 'Enter Base64 !', 'txtValue1');
            return;
        }
        const data = {
            ...formData,
    ...
    useEffect(() => {
        document.title = 'Base64 To ASCII'
            ...
            <div className='main-card card  border-0'>
                <div className='pt-1 row px-3 border-0'>
                    <div className='card-header '>
                        <h6 >{'Base64 To ASCII'} </h6>
                    </div>

                    <div className='card-body mt-3 pb-1'>
                        <p style={{ fontSize: '11px' }}>The <span>"</span>Base64 to ASCII<span>"</span> decoder is an online tool that decodes Base64 and forces the decoded result to be displayed as ASCII string.
                            Since this decoder solves some specific tasks it is recommended to use it only if you really need to change the charset encoding to ASCII (for example, this may result in discarding invalid characters and you will get a wrong result).
                            As a rule, for most scenarios the Base64 decode tool is exact what you need and I recommend using it (especially if you are not sure what kind of characters contains your Base64 string).</p>
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Base64 To ASCII converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <ul>
                        ...
                        <li style={{ fontSize: '12px', marginTop: "8px" }}>Press the "CONVERT" to "ASCII" button.</li>
                        <li style={{ fontSize: '12px', marginTop: "8px" }}>Copy the result from the "Text" field.</li>
                    </ul>
