            ...
            <div className='main-card card  border-0'>
                <div className='pt-1 row px-3 border-0'>
                    <div className='card-header '>
                        <h6 >{'Base64 To Text'} </h6>
                    </div>

                    <div className='card-body mt-3 pb-1'>
                        <p style={{ fontSize: '11px' }}>The "Base64 to Text" decoder is a simple online tool that allows you to convert Base64 to plain text (that is, it decodes the Base64 string and returns the original text).
                            If you need more features and better customization for decoding Base64, please use the Base64 decoder..</p>
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Base64 To Text converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
