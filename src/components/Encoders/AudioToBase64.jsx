...
const AudioToBase64 = () => {
    ...
    const [fileuploded, setFileUploaded] = useState('Click (or tap) here to select a Audio file');
    const fileType = 'mp3';
    ...
    const handleClear = () => {
        ...
        setResponseValue('')
        setFileUploaded('Click (or tap) here to select a Audio file')
    }
    const handleSubmit = () => {
        const base64String = formData.initialValue;
        if (!base64String) {
            AlertBox('ERROR', 'Please select Audio File !', '');
            return;
        }
        const data = {
            ...formData,
    ...
    useEffect(() => {
        document.title = 'Audio To Base64'
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <ul>
                        ...
                        <li style={{ fontSize: '12px', marginTop: "8px" }}>Select a local sound file from your computer.</li>
