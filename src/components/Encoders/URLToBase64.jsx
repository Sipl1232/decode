...
const URLToBase64 = () => {
    ...
    const handleSubmit = () => {
        ...
        if (!base64String) {
            AlertBox('ERROR', 'Enter URL !', 'txtValue1');
            return;
        }
        const data = {
            ...formData,
        ...
        <>
            <div className='main-card card  border-0'>
                <div className='pt-1 row px-3 border-0'>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        <p style={{ fontSize: '11px' }}>This online converter encodes the contents of remote file or webpage to Base64 (that is, it automatically downloads the remote data and convert it to Base64). To use it, just type or paste the URL and press <span>"</span>HexEncode URL to Base64<span>"</span>Hex(make sure that the URL is publicly available). If you need more features, for better customization check the Base64 encoder. Please do not confuse this converter with the Base64URL Encode.</p>
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">URL To Base64</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
                            ...
                            <div className='d-flex align-items-center gap-1 mb-1' style={{ fontSize: '13px' }}>
                                <button type="button"
                                    ...
                                    className="btn btn-rounded btn-secondary">Encode Url to Base64</button>
                            </div>
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <ul>
                        <li style={{ fontSize: '12px', marginTop: "8px" }}>Type or paste paste the URL-address </li>
                        <li style={{ fontSize: '12px', marginTop: "8px" }}>Press the<span>"</span>Encode URL to Base64<span>"</span> button.</li>
