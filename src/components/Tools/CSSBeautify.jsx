    ...
    const handleDownloadFile = () => {
        if (base64Content !== '') {
            try {
                ...
                link.href = url;
                link.download = 'CSS_Beautify.txt';
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">CSS Beautify</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
                            ...
                            <div className='d-flex align-items-center gap-1 mb-2 ' style={{ fontSize: '13px' }}>
                                <input
                                    id='txtauto_semicolon'
                                    type="checkbox"
                                    style={{ cursor: "pointer" }}
                                    checked={formData.auto_semicolon}
                                    onChange={(e) => { setFormData({ ...formData, auto_semicolon: e.target.checked }) }}
                                />
                                <label htmlFor='txtauto_semicolon' style={{ cursor: "pointer" }}>
                                    Insert a semicolon after the last rulesets.
                                </label>
                            </div>
                            <div className='d-flex align-items-center gap-1 mb-2 ' style={{ fontSize: '13px' }}>
                                <input
                            ...
                            <div className='fields' style={{ width: '100%', maxWidth: '1000px', }}>
                                <label className="form-label"> Beautify CSS files:</label>
                                <div className="file">
                            ...
                            <div className='d-flex align-items-center gap-1 mb-2 ' style={{ fontSize: '13px' }}>
                                <input
                                    id='txtauto_semicolonfile'
                                    type="checkbox"
                                    style={{ cursor: "pointer" }}
                                    checked={fileUploaderFormData.auto_semicolon}
                                    onChange={(e) => { setFileUploaderFormData({ ...fileUploaderFormData, auto_semicolon: e.target.checked }) }}
                                />
                                <label htmlFor='txtauto_semicolonfile' style={{ cursor: "pointer" }}>
                                    Insert a semicolon after the last rulesets.
                                </label>
                            </div>
                            <div className='d-flex align-items-center gap-1 mb-2 ' style={{ fontSize: '13px' }}>
