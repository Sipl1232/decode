...
const QuaternaryToHex = () => {
    ...
    useEffect(() => {
        document.title = 'Quaternary To Hex'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Quaternary To Hex converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Follow these steps to convert a quaternary number into hexadecimal form:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>The simplest way is to convert the quaternary number into decimal, then the decimal into hexadecimal form.</p>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>For example if the given quaternary number is 3021:</p>

                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Digit</th><th>Power</th><th>Multiplication</th></tr><tr><td>3</td><td>64</td><td>192</td></tr><tr><td>0</td><td>16</td><td>0</td></tr><tr><td>2</td><td>4</td><td>8</td></tr><tr><td>1</td><td>1</td><td>1</td></tr></tbody>
                            </table>
                        </div>
                    </div>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Then the decimal solution (192 + 8 + 1) is: 201</p>

                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Division</th><th>Quotient</th><th>Remainder</th></tr><tr><td>201 / 16</td><td>12</td><td>9</td></tr><tr><td>12 / 16</td><td>0</td><td>12 (C)</td></tr></tbody>
                            </table>
                        </div>
                    </div>

                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Finally the hexadecimal solution is: C9</p>
...
export default QuaternaryToHex;