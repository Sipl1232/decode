        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Meter To Foot converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a meter into a foot unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One meter equals to 1/0.3048 foot.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 m = 10 * ( 1 / 0.3048 = ~3.280839895 ) ft = ~32.80839895 ft</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Meter</th><th>Foot</th></tr><tr><td>1</td><td>3.280839895</td></tr><tr><td>2</td><td>6.56167979</td></tr><tr><td>3</td><td>9.842519685</td></tr><tr><td>4</td><td>13.12335958</td></tr><tr><td>5</td><td>16.404199475</td></tr><tr><td>10</td><td>32.80839895</td></tr><tr><td>25</td><td>82.020997375</td></tr><tr><td>50</td><td>164.041994751</td></tr><tr><td>100</td><td>328.083989501</td></tr><tr><td>250</td><td>820.209973753</td></tr><tr><td>500</td><td>1640.419947507</td></tr><tr><td>1000</td><td>3280.839895013</td></tr></tbody>
                            </table>
                        </div>
                    </div>
