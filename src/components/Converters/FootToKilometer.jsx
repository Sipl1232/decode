...
const FootToKilometer = () => {
    ...
    useEffect(() => {
        document.title = 'Foot To Kilometer'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Foot To Kilometer converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a foot into a kilometer unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One foot equals to 0.0003048 kilometer.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 ft = 10 * 0.0003048 km = 0.003048 km</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Foot</th><th>Kilometer</th></tr><tr><td>1</td><td>0.0003048</td></tr><tr><td>2</td><td>0.0006096</td></tr><tr><td>3</td><td>0.0009144</td></tr><tr><td>4</td><td>0.0012192</td></tr><tr><td>5</td><td>0.001524</td></tr><tr><td>10</td><td>0.003048</td></tr><tr><td>25</td><td>0.00762</td></tr><tr><td>50</td><td>0.01524</td></tr><tr><td>100</td><td>0.03048</td></tr><tr><td>250</td><td>0.0762</td></tr><tr><td>500</td><td>0.1524</td></tr><tr><td>1000</td><td>0.3048</td></tr></tbody>
                            </table>
                        </div>
                    </div>
...
export default FootToKilometer;