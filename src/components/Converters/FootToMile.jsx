        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Foot To Mile converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a foot into a mile unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One foot equals to 1/5,280 mile.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 ft = 10 * ( 1 / 5,280 = ~0.000189394 ) mi = ~0.001893939 mi</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Foot</th><th>Mile</th></tr><tr><td>1</td><td>0.000189394</td></tr><tr><td>2</td><td>0.000378788</td></tr><tr><td>3</td><td>0.000568182</td></tr><tr><td>4</td><td>0.000757576</td></tr><tr><td>5</td><td>0.00094697</td></tr><tr><td>10</td><td>0.001893939</td></tr><tr><td>25</td><td>0.004734848</td></tr><tr><td>50</td><td>0.009469697</td></tr><tr><td>100</td><td>0.018939394</td></tr><tr><td>250</td><td>0.047348485</td></tr><tr><td>500</td><td>0.09469697</td></tr><tr><td>1000</td><td>0.189393939</td></tr></tbody>
                            </table>
                        </div>
                    </div>
