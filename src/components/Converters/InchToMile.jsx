        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Inch To Mile converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert an inch into a mile unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One inch equals to 1/63,360 mile.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>0 in = 10 * ( 1 / 63,360 = ~0.000015783 ) mi = ~0.000157828 mi</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Inch</th><th>Mile</th></tr><tr><td>1</td><td>0.000015783</td></tr><tr><td>2</td><td>0.000031566</td></tr><tr><td>3</td><td>0.000047348</td></tr><tr><td>4</td><td>0.000063131</td></tr><tr><td>5</td><td>0.000078914</td></tr><tr><td>10</td><td>0.000157828</td></tr><tr><td>25</td><td>0.000394571</td></tr><tr><td>50</td><td>0.000789141</td></tr><tr><td>100</td><td>0.001578283</td></tr><tr><td>250</td><td>0.003945707</td></tr><tr><td>500</td><td>0.007891414</td></tr><tr><td>1000</td><td>0.015782828</td></tr></tbody>
                            </table>
                        </div>
                    </div>
