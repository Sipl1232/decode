...
const DecimalToQuinary = () => {
    ...
    const handleSubmit = () => {
        ...
        setIsLoading(true)
        post('/decimal_to_quinary', { ...data }, (res) => {
    ...
    useEffect(() => {
        document.title = 'Decimal To Quinary'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Decimal To Quinary Converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Follow these steps to convert a decimal number into quinary form:</p>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>For example if the given decimal number is 673:</p>

                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Division</th><th>Quotient</th><th>Remainder</th></tr><tr><td>673 / 5</td><td>134</td><td>3</td></tr><tr><td>134 / 5</td><td>26</td><td>4</td></tr><tr><td>26 / 5</td><td>5</td><td>1</td></tr><tr><td>5 / 5</td><td>1</td><td>0</td></tr><tr><td>1 / 5</td><td>0</td><td>1</td></tr></tbody>
                            </table>
                        </div>
                    </div>

                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Then the quinary solution is: 10143</p>
...
export default DecimalToQuinary;