        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Meter To Inch converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a meter into an inch unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One meter equals to 1/0.0254 inch.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 m = 10 * ( 1 / 0.0254 = ~39.37007874 ) in = ~393.700787402 in</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Meter</th><th>Inch</th></tr><tr><td>1</td><td>39.37007874</td></tr><tr><td>2</td><td>78.74015748</td></tr><tr><td>3</td><td>118.11023622</td></tr><tr><td>4</td><td>157.480314961</td></tr><tr><td>5</td><td>196.850393701</td></tr><tr><td>10</td><td>393.700787402</td></tr><tr><td>25</td><td>984.251968504</td></tr><tr><td>50</td><td>1968.503937008</td></tr><tr><td>100</td><td>3937.007874016</td></tr><tr><td>250</td><td>9842.519685039</td></tr><tr><td>500</td><td>19685.039370079</td></tr><tr><td>1000</td><td>39370.078740157</td></tr></tbody>
                            </table>
                        </div>
                    </div>
