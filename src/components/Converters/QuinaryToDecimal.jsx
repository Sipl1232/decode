...
const QuinaryToDecimal = () => {
    ...
    const handleSubmit = () => {
        ...
        setIsLoading(true)
        post('/quinary_to_decimal', { ...data }, (res) => {
    ...
    useEffect(() => {
        document.title = 'Quinary To Decimal'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Quinary To Decimal converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Follow these steps to convert a quinary number into decimal form:</p>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>For example if the given quinary number is 24301:</p>

                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Digit</th><th>Power</th><th>Multiplication</th></tr><tr><td>2</td><td>625</td><td>1250</td></tr><tr><td>4</td><td>125</td><td>500</td></tr><tr><td>3</td><td>25</td><td>75</td></tr><tr><td>0</td><td>5</td><td>0</td></tr><tr><td>1</td><td>1</td><td>1</td></tr></tbody>
                            </table>
                        </div>
                    </div>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Then the decimal solution (1250 + 500 + 75 + 1) is: 1826</p>
...
export default QuinaryToDecimal;