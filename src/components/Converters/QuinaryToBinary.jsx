...
const QuinaryToBinary = () => {
    ...
    const handleSubmit = () => {
        ...
        setIsLoading(true)
        post('/quinary_to_binary', { ...data }, (res) => {
    ...
    useEffect(() => {
        document.title = 'Quinary To Binary'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Quinary To Binary converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Follow these steps to convert a quinary number into binary form:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>The simplest way is to convert the quinary number into decimal, then the decimal into binary form.</p>
                    ...
                    <ol style={{ fontSize: '12px' }}>
                        ...
                        <li>Get the integer quotient for the next iteration (if the number will not divide equally by 2, then round down the result to the nearest whole number).</li>
                        <li>Keep a note of the remainder, it should be between 0 and 1.</li>
                        <li>Repeat the steps from step 4. until the quotient is equal to 0.</li>
                        <li>Write out all the remainders, from bottom to top. This is the binary solution.</li>
                    </ol>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>For example if the given quinary number is 3012:</p>

                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Digit</th><th>Power</th><th>Multiplication</th></tr><tr><td>3</td><td>125</td><td>375</td></tr><tr><td>0</td><td>25</td><td>0</td></tr><tr><td>1</td><td>5</td><td>5</td></tr><tr><td>2</td><td>1</td><td>2</td></tr></tbody>
                            </table>
                        </div>
                    </div>

                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Then the decimal solution (375 + 5 + 2) is: 382</p>

                     <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Division</th><th>Quotient</th><th>Remainder</th></tr><tr><td>382 / 2</td><td>191</td><td>0</td></tr><tr><td>191 / 2</td><td>95</td><td>1</td></tr><tr><td>95 / 2</td><td>47</td><td>1</td></tr><tr><td>47 / 2</td><td>23</td><td>1</td></tr><tr><td>23 / 2</td><td>11</td><td>1</td></tr><tr><td>11 / 2</td><td>5</td><td>1</td></tr><tr><td>5 / 2</td><td>2</td><td>1</td></tr><tr><td>2 / 2</td><td>1</td><td>0</td></tr><tr><td>1 / 2</td><td>0</td><td>1</td></tr></tbody>
                            </table>
                        </div>
                    </div>

                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Finally the binary solution is: 101111110</p>
...
export default QuinaryToBinary;