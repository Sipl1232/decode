...
const MileToKilometer = () => {
    ...
    useEffect(() => {
        document.title = 'Mile To Kilometer'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Mile To Kilometer converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a mile into a kilometer unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One mile equals to 1.609344 kilometer.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 mi = 10 * 1.609344 km = 16.09344 km</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Mile</th><th>Kilometer</th></tr><tr><td>1</td><td>1.609344</td></tr><tr><td>2</td><td>3.218688</td></tr><tr><td>3</td><td>4.828032</td></tr><tr><td>4</td><td>6.437376</td></tr><tr><td>5</td><td>8.04672</td></tr><tr><td>10</td><td>16.09344</td></tr><tr><td>25</td><td>40.2336</td></tr><tr><td>50</td><td>80.4672</td></tr><tr><td>100</td><td>160.9344</td></tr><tr><td>250</td><td>402.336</td></tr><tr><td>500</td><td>804.672</td></tr><tr><td>1000</td><td>1609.344</td></tr></tbody>
                            </table>
                        </div>
                    </div>
...
export default MileToKilometer;