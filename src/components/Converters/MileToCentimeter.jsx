...
const MileToCentimeter = () => {
    ...
    useEffect(() => {
        document.title = 'Mile To Centimeter'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Mile To Centimeter converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a mile into a centimeter unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One mile equals to 160,934.4 centimeter.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 mi = 10 * 160,934.4 cm = 1,609,344 cm</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Mile</th><th>Centimeter</th></tr><tr><td>1</td><td>160934.4</td></tr><tr><td>2</td><td>321868.8</td></tr><tr><td>3</td><td>482803.2</td></tr><tr><td>4</td><td>643737.6</td></tr><tr><td>5</td><td>804672</td></tr><tr><td>10</td><td>1609344</td></tr><tr><td>25</td><td>4023360</td></tr><tr><td>50</td><td>8046720</td></tr><tr><td>100</td><td>16093440</td></tr><tr><td>250</td><td>40233600</td></tr><tr><td>500</td><td>80467200</td></tr><tr><td>1000</td><td>160934400</td></tr></tbody>
                            </table>
                        </div>
                    </div>
...
export default MileToCentimeter;