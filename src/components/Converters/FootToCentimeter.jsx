...
const FootToCentimeter = () => {
    ...
    useEffect(() => {
        document.title = 'Foot To Centimeter'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Foot To Centimeter converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a foot into a centimeter unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One foot equals to 30.48 centimeter.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 ft = 10 * 30.48 cm = 304.8 cm</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Foot</th><th>Centimeter</th></tr><tr><td>1</td><td>30.48</td></tr><tr><td>2</td><td>60.96</td></tr><tr><td>3</td><td>91.44</td></tr><tr><td>4</td><td>121.92</td></tr><tr><td>5</td><td>152.4</td></tr><tr><td>10</td><td>304.8</td></tr><tr><td>25</td><td>762</td></tr><tr><td>50</td><td>1524</td></tr><tr><td>100</td><td>3048</td></tr><tr><td>250</td><td>7620</td></tr><tr><td>500</td><td>15240</td></tr><tr><td>1000</td><td>30480</td></tr></tbody>
                            </table>
                        </div>
                    </div>
...
export default FootToCentimeter;