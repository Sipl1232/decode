...
const InchToCentimeter = () => {
    ...
    useEffect(() => {
        document.title = 'Inch To Centimeter'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Inch To Centimeter converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert an inch into a centimeter unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One inch equals to 2.54 centimeter.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 in = 10 * 2.54 cm = 25.4 cm</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Inch</th><th>Centimeter</th></tr><tr><td>1</td><td>2.54</td></tr><tr><td>2</td><td>5.08</td></tr><tr><td>3</td><td>7.62</td></tr><tr><td>4</td><td>10.16</td></tr><tr><td>5</td><td>12.7</td></tr><tr><td>10</td><td>25.4</td></tr><tr><td>25</td><td>63.5</td></tr><tr><td>50</td><td>127</td></tr><tr><td>100</td><td>254</td></tr><tr><td>250</td><td>635</td></tr><tr><td>500</td><td>1270</td></tr><tr><td>1000</td><td>2540</td></tr></tbody>
                            </table>
                        </div>
                    </div>
...
export default InchToCentimeter;