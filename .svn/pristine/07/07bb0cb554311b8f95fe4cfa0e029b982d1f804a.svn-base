...
const CentimeterToFoot = () => {
    ...
    useEffect(() => {
        document.title = 'Centimeter To Foot'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Centimeter To Foot converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a centimeter into a foot unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One centimeter equals to 1/30.48 foot.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 cm = 10 * ( 1 / 30.48 = ~0.032808399 ) ft = ~0.32808399 ft</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Centimeter</th><th>Foot</th></tr><tr><td>1</td><td>0.032808399</td></tr><tr><td>2</td><td>0.065616798</td></tr><tr><td>3</td><td>0.098425197</td></tr><tr><td>4</td><td>0.131233596</td></tr><tr><td>5</td><td>0.164041995</td></tr><tr><td>10</td><td>0.32808399</td></tr><tr><td>25</td><td>0.820209974</td></tr><tr><td>50</td><td>1.640419948</td></tr><tr><td>100</td><td>3.280839895</td></tr><tr><td>250</td><td>8.202099738</td></tr><tr><td>500</td><td>16.404199475</td></tr><tr><td>1000</td><td>32.80839895</td></tr></tbody>
                            </table>
                        </div>
                    </div>
...
export default CentimeterToFoot;