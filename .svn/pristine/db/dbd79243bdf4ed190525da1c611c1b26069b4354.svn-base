        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Meter To Mile converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a meter into a mile unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One meter equals to 1/1609.344 mile.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 m = 10 * ( 1 / 1609.344 = 0.000621371 ) mi = 0.006213712 mi</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Meter</th><th>Mile</th></tr><tr><td>1</td><td>0.000621371</td></tr><tr><td>2</td><td>0.001242742</td></tr><tr><td>3</td><td>0.001864114</td></tr><tr><td>4</td><td>0.002485485</td></tr><tr><td>5</td><td>0.003106856</td></tr><tr><td>10</td><td>0.006213712</td></tr><tr><td>25</td><td>0.01553428</td></tr><tr><td>50</td><td>0.03106856</td></tr><tr><td>100</td><td>0.062137119</td></tr><tr><td>250</td><td>0.155342798</td></tr><tr><td>500</td><td>0.310685596</td></tr><tr><td>1000</td><td>0.621371192</td></tr></tbody>
                            </table>
                        </div>
                    </div>
