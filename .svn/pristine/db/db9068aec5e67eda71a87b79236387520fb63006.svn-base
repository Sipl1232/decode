        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Mile To Inch converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a mile into an inch unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One mile equals to 63,360 inch.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 mi = 10 * 63,360 in = 633,600 in</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Mile</th><th>Inch</th></tr><tr><td>1</td><td>63360</td></tr><tr><td>2</td><td>126720</td></tr><tr><td>3</td><td>190080</td></tr><tr><td>4</td><td>253440</td></tr><tr><td>5</td><td>316800</td></tr><tr><td>10</td><td>633600</td></tr><tr><td>25</td><td>1584000</td></tr><tr><td>50</td><td>3168000</td></tr><tr><td>100</td><td>6336000</td></tr><tr><td>250</td><td>15840000</td></tr><tr><td>500</td><td>31680000</td></tr><tr><td>1000</td><td>63360000</td></tr></tbody>
                            </table>
                        </div>
                    </div>
