...
const JSONBeautify = () => {
    ...
    const handleBeautifyFileUploader = () => {
        const data = {
    ...
    const handleDownloadFile = () => {
        ...
        if (base64Content !== '') {
            try {
                ...
                link.href = url;
                link.download = 'BeautifyJSON.txt';
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">JSON Beautify</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
                            ...
                            <div className='fields' style={{ width: '100%', maxWidth: '1000px', }}>
                                <label className="form-label"> Beautify JSON files:</label>
                                <div className="file">
                            ...
                            <div>
                                <button
                                    type="button"
                                    onClick={() => handleBeautifyFileUploader()}
