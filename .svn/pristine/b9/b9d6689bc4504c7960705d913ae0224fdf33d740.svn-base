...
const DecimalToBinary = () => {
    ...
    const handleSubmit = () => {
        ...
        setIsLoading(true)
        post('/decimal_to_binary', { ...data }, (res) => {
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Decimal To Binary converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Follow these steps to convert a decimal number into binary form:</p>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>For example if the given decimal number is 139:</p>

                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Division</th><th>Quotient</th><th>Remainder</th></tr><tr><td>139 / 2</td><td>69</td><td>1</td></tr><tr><td>69 / 2</td><td>34</td><td>1</td></tr><tr><td>34 / 2</td><td>17</td><td>0</td></tr><tr><td>17 / 2</td><td>8</td><td>1</td></tr><tr><td>8 / 2</td><td>4</td><td>0</td></tr><tr><td>4 / 2</td><td>2</td><td>0</td></tr><tr><td>2 / 2</td><td>1</td><td>0</td></tr><tr><td>1 / 2</td><td>0</td><td>1</td></tr></tbody>
                            </table>
                        </div>
                    </div>

                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Then the binary solution is: 10001011</p>
