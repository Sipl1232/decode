...
const KilometerToMeter = () => {
    ...
    useEffect(() => {
        document.title = 'Kilometer To Meter'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Kilometer To Meter converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a kilometer into a meter unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One kilometer equals to 1,000 meter.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 km = 10 * 1,000 m = 10,000 m</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Kilometer</th><th>Meter</th></tr><tr><td>1</td><td>1000</td></tr><tr><td>2</td><td>2000</td></tr><tr><td>3</td><td>3000</td></tr><tr><td>4</td><td>4000</td></tr><tr><td>5</td><td>5000</td></tr><tr><td>10</td><td>10000</td></tr><tr><td>25</td><td>25000</td></tr><tr><td>50</td><td>50000</td></tr><tr><td>100</td><td>100000</td></tr><tr><td>250</td><td>250000</td></tr><tr><td>500</td><td>500000</td></tr><tr><td>1000</td><td>1000000</td></tr></tbody>
                            </table>
                        </div>
                    </div>
...
export default KilometerToMeter;