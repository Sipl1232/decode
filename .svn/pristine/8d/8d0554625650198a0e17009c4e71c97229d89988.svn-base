...
const InchToKilometer = () => {
    ...
    useEffect(() => {
        document.title = 'Inch To Kilometer'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Inch To Kilometer converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert an inch into a kilometer unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One inch equals to 0.0000254 kilometer.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 in = 10 * 0.0000254 km = 0.000254 km</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Inch</th><th>Kilometer</th></tr><tr><td>1</td><td>0.0000254</td></tr><tr><td>2</td><td>0.0000508</td></tr><tr><td>3</td><td>0.0000762</td></tr><tr><td>4</td><td>0.0001016</td></tr><tr><td>5</td><td>0.000127</td></tr><tr><td>10</td><td>0.000254</td></tr><tr><td>25</td><td>0.000635</td></tr><tr><td>50</td><td>0.00127</td></tr><tr><td>100</td><td>0.00254</td></tr><tr><td>250</td><td>0.00635</td></tr><tr><td>500</td><td>0.0127</td></tr><tr><td>1000</td><td>0.0254</td></tr></tbody>
                            </table>
                        </div>
                    </div>
...
export default InchToKilometer;