...
const OctalToQuaternary = () => {
    ...
    useEffect(() => {
        document.title = 'Octal To Quaternary'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Octal To Quaternary converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Follow these steps to convert a octal number into quaternary form:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>The simplest way is to convert the octal number into decimal, then the decimal into quaternary form.</p>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>For example if the given octal number is 3602:</p>

                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Digit</th><th>Power</th><th>Multiplication</th></tr><tr><td>3</td><td>512</td><td>1536</td></tr><tr><td>6</td><td>64</td><td>384</td></tr><tr><td>0</td><td>8</td><td>0</td></tr><tr><td>2</td><td>1</td><td>2</td></tr></tbody>
                            </table>
                        </div>
                    </div>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Then the decimal solution (1536 + 384 + 2) is: 1922</p>

                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Division</th><th>Quotient</th><th>Remainder</th></tr><tr><td>1922 / 4</td><td>480</td><td>2</td></tr><tr><td>480 / 4</td><td>120</td><td>0</td></tr><tr><td>120 / 4</td><td>30</td><td>0</td></tr><tr><td>30 / 4</td><td>7</td><td>2</td></tr><tr><td>7 / 4</td><td>1</td><td>3</td></tr><tr><td>1 / 4</td><td>0</td><td>1</td></tr></tbody>
                            </table>
                        </div>
                    </div>

                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Finally the quaternary solution is: 132002</p>
...
export default OctalToQuaternary;