...
const CentimeterToInch = () => {
    ...
    useEffect(() => {
        document.title = 'Centimeter To Inch'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Centimeter To Inch converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a centimeter into an inch unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One centimeter equals to 1/2.54 inch.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 cm = 10 * ( 1 / 2.54 = ~0.393700787 ) in = ~3.937007874 in</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Centimeter</th><th>Inch</th></tr><tr><td>1</td><td>0.393700787</td></tr><tr><td>2</td><td>0.787401575</td></tr><tr><td>3</td><td>1.181102362</td></tr><tr><td>4</td><td>1.57480315</td></tr><tr><td>5</td><td>1.968503937</td></tr><tr><td>10</td><td>3.937007874</td></tr><tr><td>25</td><td>9.842519685</td></tr><tr><td>50</td><td>19.68503937</td></tr><tr><td>100</td><td>39.37007874</td></tr><tr><td>250</td><td>98.42519685</td></tr><tr><td>500</td><td>196.850393701</td></tr><tr><td>1000</td><td>393.700787402</td></tr></tbody>
                            </table>
                        </div>
                    </div>
...
export default CentimeterToInch;