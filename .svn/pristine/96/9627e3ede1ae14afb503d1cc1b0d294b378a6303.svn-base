...
const KilometerToMile = () => {
    ...
    useEffect(() => {
        document.title = 'Kilometer To Mile'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Kilometer To Mile converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a kilometer into a mile unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One kilometer equals to 1/1.609344 mile.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 km = 10 * ( 1 / 1.609344 = ~0.621371192 ) mi = ~6.213711922 mi</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Kilometer</th><th>Mile</th></tr><tr><td>1</td><td>0.621371192</td></tr><tr><td>2</td><td>1.242742384</td></tr><tr><td>3</td><td>1.864113577</td></tr><tr><td>4</td><td>2.485484769</td></tr><tr><td>5</td><td>3.106855961</td></tr><tr><td>10</td><td>6.213711922</td></tr><tr><td>25</td><td>15.534279806</td></tr><tr><td>50</td><td>31.068559612</td></tr><tr><td>100</td><td>62.137119224</td></tr><tr><td>250</td><td>155.342798059</td></tr><tr><td>500</td><td>310.685596119</td></tr><tr><td>1000</td><td>621.371192237</td></tr></tbody>
                            </table>
                        </div>
                    </div>
...
export default KilometerToMile;