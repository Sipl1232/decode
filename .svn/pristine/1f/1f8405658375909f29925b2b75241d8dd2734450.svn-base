...
const CentimeterToMile = () => {
    ...
    useEffect(() => {
        document.title = 'Centimeter To Mile'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Centimeter To Mile converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
                            ...
                            <p style={{ fontSize: '11px' }}>All matching values are converted to their equalient in miles:</p>
                            <div className="fields">
                                <textarea
                                    id='txtValue2'
                                    rows="10"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "10px" }}>The mile is an English unit of length of linear measure equal to 5,280 feet, or 1,760 yards, and standardised as exactly 1,609.344 metres by international agreement in 1959.</p>

                    <div style={{ fontSize: '13px', fontWeight: "700", marginTop: "10px" }}>Formula</div>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a centimeter into a mile unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One centimeter equals to 1/160,934.4 mile.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 cm = 10 * ( 1 / 160,934.4 = ~0.000006214 ) mi = ~0.000062137 mi</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Centimeter</th><th>Mile</th></tr><tr><td>1</td><td>0.000006214</td></tr><tr><td>2</td><td>0.000012427</td></tr><tr><td>3</td><td>0.000018641</td></tr><tr><td>4</td><td>0.000024855</td></tr><tr><td>5</td><td>0.000031069</td></tr><tr><td>10</td><td>0.000062137</td></tr><tr><td>25</td><td>0.000155343</td></tr><tr><td>50</td><td>0.000310686</td></tr><tr><td>100</td><td>0.000621371</td></tr><tr><td>250</td><td>0.001553428</td></tr><tr><td>500</td><td>0.003106856</td></tr><tr><td>1000</td><td>0.006213712</td></tr></tbody>
                            </table>
                        </div>
                    </div>
...
export default CentimeterToMile;