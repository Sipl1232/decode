...
const QuaternaryToOctal = () => {
    ...
    useEffect(() => {
        document.title = 'Quaternary To Octal'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Quaternary To Octal converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Follow these steps to convert a quaternary number into octal form:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>The simplest way is to convert the quaternary number into decimal, then the decimal into octal form.</p>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>For example if the given quaternary number is 13023:</p>

                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Digit</th><th>Power</th><th>Multiplication</th></tr><tr><td>1</td><td>256</td><td>256</td></tr><tr><td>3</td><td>64</td><td>192</td></tr><tr><td>0</td><td>16</td><td>0</td></tr><tr><td>2</td><td>4</td><td>8</td></tr><tr><td>3</td><td>1</td><td>3</td></tr></tbody>
                            </table>
                        </div>
                    </div>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Then the decimal solution (256 + 192 + 8 + 3) is: 459</p>

                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Division</th><th>Quotient</th><th>Remainder</th></tr><tr><td>459 / 8</td><td>57</td><td>3</td></tr><tr><td>57 / 8</td><td>7</td><td>1</td></tr><tr><td>7 / 8</td><td>0</td><td>7</td></tr></tbody>
                            </table>
                        </div>
                    </div>

                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Finally the octal solution is: 713</p>
...
export default QuaternaryToOctal;