        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Hex To Octal converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Follow these steps to convert a hexadecimal number into octal form:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>The simplest way is to convert the hexadecimal number into decimal, then the decimal into octal form.</p>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>For example if the given hexadecimal number is B8A:</p>

                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Digit</th><th>Power</th><th>Multiplication</th></tr><tr><td>B (11)</td><td>256</td><td>2816</td></tr><tr><td>8</td><td>16</td><td>128</td></tr><tr><td>A (10)</td><td>1</td><td>10</td></tr></tbody>
                            </table>
                        </div>
                    </div>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Then the decimal solution (2816 + 128 + 10) is: 2954</p>

                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Division</th><th>Quotient</th><th>Remainder</th></tr><tr><td>2954 / 8</td><td>369</td><td>2</td></tr><tr><td>369 / 8</td><td>46</td><td>1</td></tr><tr><td>46 / 8</td><td>5</td><td>6</td></tr><tr><td>5 / 8</td><td>0</td><td>5</td></tr></tbody>
                            </table>
                        </div>
                    </div>

                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Finally the octal solution is: 5612</p>
