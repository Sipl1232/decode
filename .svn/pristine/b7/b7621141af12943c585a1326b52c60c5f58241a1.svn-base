        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Inch To Foot converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert an inch into a foot unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One inch equals to 1/12 foot.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 in = 10 * ( 1 / 12 = ~0.083333333 ) ft = ~0.833333333 ft</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Inch</th><th>Foot</th></tr><tr><td>1</td><td>0.083333333</td></tr><tr><td>2</td><td>0.166666667</td></tr><tr><td>3</td><td>0.25</td></tr><tr><td>4</td><td>0.333333333</td></tr><tr><td>5</td><td>0.416666667</td></tr><tr><td>10</td><td>0.833333333</td></tr><tr><td>25</td><td>2.083333333</td></tr><tr><td>50</td><td>4.166666667</td></tr><tr><td>100</td><td>8.333333333</td></tr><tr><td>250</td><td>20.833333333</td></tr><tr><td>500</td><td>41.666666667</td></tr><tr><td>1000</td><td>83.333333333</td></tr></tbody>
                            </table>
                        </div>
                    </div>
