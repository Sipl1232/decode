...
const BinaryToQuinary = () => {
    ...
    useEffect(() => {
        document.title = 'Binary To Quinary'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Binary To Quinary converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Follow these steps to convert a binary number into quinary form:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>The simplest way is to convert the binary number into decimal, then the decimal into quinary form.</p>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>For example if the given binary number is 100101:</p>

                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Digit</th><th>Power</th><th>Multiplication</th></tr><tr><td>1</td><td>32</td><td>32</td></tr><tr><td>0</td><td>16</td><td>0</td></tr><tr><td>0</td><td>8</td><td>0</td></tr><tr><td>1</td><td>4</td><td>4</td></tr><tr><td>0</td><td>2</td><td>0</td></tr><tr><td>1</td><td>1</td><td>1</td></tr></tbody>
                            </table>
                        </div>
                    </div>

                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Then the decimal solution (32 + 4 + 1) is: 37</p>

                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Division</th><th>Quotient</th><th>Remainder</th></tr><tr><td>37 / 5</td><td>7</td><td>2</td></tr><tr><td>7 / 5</td><td>1</td><td>2</td></tr><tr><td>1 / 5</td><td>0</td><td>1</td></tr></tbody>
                            </table>
                        </div>
                    </div>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Finally the quinary solution is: 122</p>
...
export default BinaryToQuinary;