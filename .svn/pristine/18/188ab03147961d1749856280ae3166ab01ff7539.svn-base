...
const MeterToKilometer = () => {
    ...
    useEffect(() => {
        document.title = 'Meter To Kilometer'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Meter To Kilometer converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a meter into a kilometer unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One meter equals to 1/1,000 kilometer.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 m = 10 * ( 1 / 1,000 = 0.001 ) km = 0.01 km</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Meter</th><th>Kilometer</th></tr><tr><td>1</td><td>0.001</td></tr><tr><td>2</td><td>0.002</td></tr><tr><td>3</td><td>0.003</td></tr><tr><td>4</td><td>0.004</td></tr><tr><td>5</td><td>0.005</td></tr><tr><td>10</td><td>0.01</td></tr><tr><td>25</td><td>0.025</td></tr><tr><td>50</td><td>0.05</td></tr><tr><td>100</td><td>0.1</td></tr><tr><td>250</td><td>0.25</td></tr><tr><td>500</td><td>0.5</td></tr><tr><td>1000</td><td>1</td></tr></tbody>
                            </table>
                        </div>
                    </div>
