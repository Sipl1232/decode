...
const KilometerToInch = () => {
    ...
    useEffect(() => {
        document.title = 'Kilometer To Inch'
        ...
        <>
                    ...
                    <div className='card-body mt-3 pb-1'>
                        ...
                        <div className='row'>
                            <div className="fields  ">
                                <label className="form-label">Kilometer To Inch converter</label>
                                <textarea
                                    id='txtValue1'
                                    rows="3"
                                    type="text"
            ...
            <div className='main-card card  border-0'>
                <div className='card-body mt-3 pb-1'>
                    ...
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>Use the following method to convert a kilometer into an inch unit:</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>One kilometer equals to 1/0.0000254 inch.</p>
                    <p style={{ fontSize: '12px', marginTop: "8px" }}>10 km = 10 * ( 1 / 0.0000254 = ~39,370.078740157 ) in = ~393,700.787401575 in</p>
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <table className='table table-bordered  mb-0'>
                                <tbody><tr><th>Kilometer</th><th>Inch</th></tr><tr><td>1</td><td>39370.078740157</td></tr><tr><td>2</td><td>78740.157480315</td></tr><tr><td>3</td><td>118110.236220472</td></tr><tr><td>4</td><td>157480.31496063</td></tr><tr><td>5</td><td>196850.393700787</td></tr><tr><td>10</td><td>393700.787401575</td></tr><tr><td>25</td><td>984251.968503937</td></tr><tr><td>50</td><td>1968503.937007874</td></tr><tr><td>100</td><td>3937007.874015748</td></tr><tr><td>250</td><td>9842519.68503937</td></tr><tr><td>500</td><td>19685039.37007874</td></tr><tr><td>1000</td><td>39370078.74015748</td></tr></tbody>
                            </table>
                        </div>
                    </div>
...
export default KilometerToInch;